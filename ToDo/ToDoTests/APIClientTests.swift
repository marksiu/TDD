...
class APIClientTests: XCTestCase {
    ...
    func test_Login_UsersExpectedURL() {
        let sut = APIClient()
        let mockURLSession =
        ...
        guard let expectedPassword = "%&34".addingPercentEncoding(
            withAllowedCharacters: allowedCharacters) else { fatalError() }
        // TODO: work on queryItems
//        let usernameQueryItem = URLQueryItem(name: "username", value: expectedUsername)
//        let passwordQueryItem = URLQueryItem(name: "password", value: expectedPassword)
//        let queryItems = [usernameQueryItem, passwordQueryItem]
